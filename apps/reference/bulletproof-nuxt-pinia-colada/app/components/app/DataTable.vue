        ...
        <div class="overflow-hidden rounded-xl">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead
                  ...
                  :class="cn(
                    column.class,
                    column.name === 'delete' || column.name === 'view' ? 'w-20 text-right' : undefined,
                  )"
                >
                  {{ column.title }}
                </TableHead>
            ...
            <TableBody>
              ...
              >
                <TableCell
                  v-for="({ field, title: columnTitle, name, class: columnClass }, columnIndex) in columns"
                  :key="columnTitle + columnIndex"
                  :class="cn(
                    columnClass,
                    name === 'delete' || name === 'view' ? 'text-right' : undefined,
                  )"
                >
                  <slot
